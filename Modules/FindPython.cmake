...
EXECUTE_PROCESS(COMMAND "${PYTHON_EXECUTABLE}" "-c" "from sys import *; stdout.write(prefix)" OUTPUT_VARIABLE _PYTHON_PREFIX)
EXECUTE_PROCESS(COMMAND "${PYTHON_EXECUTABLE}" "-c" "from sys import *; stdout.write(exec_prefix)" OUTPUT_VARIABLE _PYTHON_EPREFIX)


set(PYTHON_INCLUDE_DIRS "${_PYTHON_PREFIX}/include/python${_PYTHON_VERSION}")
set(PYTHON_LIBRARIES "${_PYTHON_EPREFIX}/lib/${CMAKE_SHARED_MODULE_PREFIX}python${_PYTHON_VERSION}${CMAKE_SHARED_MODULE_SUFFIX}")
